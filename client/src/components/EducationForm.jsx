    ...
    <div className='space-y-6'>
        <div>
            ...
            <div>
                ...
                <p className='text-sm text-gray-500'>Add your educational background here</p>
            </div>
        ...
        <div key={index} className='p-4 border-gray-200 rounded-lg space-y-3'>
            ...
            <div className='grid md:grid-cols-2 gap-3'>
              ...
              <input value={education.degree || ""} onChange={(e)=>updateEducation(index, "degree", e.target.value)} type='text' placeholder='Degree' className='px-3 py-2 text-sm'/>
                ...
                <input value={education.graduation_date || ""} onChange={(e)=>updateEducation(index, "graduation_date", e.target.value)} type='month' placeholder='Graduation Date' className='px-3 py-2 text-sm '/>
                <input value={education.gpa || ""} onChange={(e)=>updateEducation(index, "gpa", e.target.value)} type='number' placeholder='GPA (optional)' className='px-3 py-2 text-sm  '/>
            </div>
