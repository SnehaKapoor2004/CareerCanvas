...
const Testimonial = () => {
            ...
            <div className="flex gap-2">
                ...
                <div className="flex flex-col">
                    <div className="flex items-center gap-1">
                        <p>{card.name}</p>
                        <svg className="mt-0.5 text-green-500" width="12" height="12" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
  ...
  return (
   ...
   <div className="flex items-center gap-2 text-sm text-green-800 bg-green-400/10 rounded-full px-6 py-1.5">
    ...
    <Title title="Don't just take our word" description="Hear what our users say about us. We're always for ways to improve. If you have a positive experience with us, leave a review."/>
    </div>
