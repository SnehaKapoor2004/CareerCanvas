...
const ModernTemplate = ({ data, accentColor }) => {
	...
	return (
		<div className="max-w-4xl mx-auto bg-white text-gray-800 overflow-hidden">
			{/* Header */}
		<header
  className="p-4 sm:p-6 md:p-8 text-white"
  style={{ backgroundColor: accentColor }}
>
				<h1 className="text-2xl sm:text-3xl md:text-4xl font-light mb-3 break-words">
						...
						<div className="space-y-6">
							{data.experience.map((exp, index) => (
								...
								<div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2 mb-2">
										...
										<div className="text-xs sm:text-sm text-gray-500 bg-gray-100 px-3 py-1 rounded w-fit">
							...
							<div className="space-y-4">
								{data.education.map((edu, index) => (
									<div key={index}>
										...
										<div className="flex flex-col sm:flex-row sm:justify-between sm:items-center text-sm text-gray-600 gap-1">
						...
						<section>
							...
							<div className="flex flex-wrap gap-2">
								{data.skills.map((skill, index) => (
									<span
										key={index}
									className="px-2 sm:px-3 py-1 text-xs sm:text-sm text-white rounded-full break-words"
										style={{ backgroundColor: accentColor }}
									>
										{skill}
									</span>
